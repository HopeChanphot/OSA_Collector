...
public class oxp extends AppCompatActivity {


    private static final String TAG = "oxpActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_oxp);
    ...
    private final PreviewCallback previewCallback = new PreviewCallback() {
        ...
        public void onPreviewFrame(byte[] data, Camera cam) {
            ...
            if (o2 != 0) {
                Intent i = new Intent(oxp.this, oxr.class);
                i.putExtra("O2R", o2);
                startActivity(i);
                finish();
            }
